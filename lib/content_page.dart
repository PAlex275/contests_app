...
import 'package:flutter_getx/popular_contest.dart';
              ...
              child: Container(
                ...
                child: Row(
                  children: [
                    CircleAvatar(
                      radius: 40,
                      backgroundImage: AssetImage(info[0]['img']),
                    ),
                    const SizedBox(
                      width: 10,
                    ),
                    Column(
                      ...
                      children: const [
                        ...
                        Text(
                          "Senior Level",
                          style: TextStyle(
                            color: Color.fromARGB(255, 246, 210, 89),
                            fontSize: 12,
                            decoration: TextDecoration.none,
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: GestureDetector(
                      onTap: () => Get.to(() => const PopularContest()),
                      child: const Icon(
